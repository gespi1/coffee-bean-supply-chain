...
contract SupplyChain is Ownable, FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
  ...
  // Call modifier to check if upc has passed previous supply chain stage
  // Call modifier to verify caller of this function
  function packItem(uint _upc) processed(upc) verifyCaller(items[upc].ownerID) public 
  {
    // Update the appropriate fields
  ...
  // Call modifier to check if upc has passed previous supply chain stage
  // Call modifier to verify caller of this function
  function sellItem(uint _upc, uint _price) packed(upc) verifyCaller(items[upc].ownerID) public {
    // Update the appropriate fields
  ...
  // Call modifier to check if upc has passed previous supply chain stage
  // Call modifier to verify caller of this function
  function shipItem(uint _upc) sold(upc) verifyCaller(items[upc].ownerID) public {
    // Update the appropriate fields
  ...
  // Call modifier to check if upc has passed previous supply chain stage
  // Access Control List enforced by calling Smart Contract / DApp
  function purchaseItem(uint _upc) received(upc) paidEnough(items[upc].productPrice) checkValue(upc) public payable {
    // Update the appropriate fields - ownerID, consumerID, itemState
    items[_upc].ownerID = msg.sender;
    items[_upc].consumerID = msg.sender;
    items[_upc].itemState = State.Purchased;
    items[_upc].retailerID.transfer(items[upc].productPrice);
    // Emit the appropriate event
    emit Purchased(_upc);
